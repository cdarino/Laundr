...
public class LaundromatDetailsPanel extends JPanel {
    ...
    public void setLaundromat(LaundromatData data) {
        ...
        JLabel name = new JLabel(iconCreator.getIcon("laundromatLogo.svg", 24, 24));
        name.setText(" " + data.name);
        name.setFont(UIManager.getFont("Label.font").deriveFont(Font.BOLD, 16f));

        JLabel addr = new JLabel(iconCreator.getIcon("address.svg", 16, 16));
        addr.setText(" " + data.address);

        JLabel dist = new JLabel(iconCreator.getIcon("distancefromUser.svg", 16, 16));
        dist.setText(" " + data.distance);

        JLabel period = new JLabel(iconCreator.getIcon("deliveryperiod.svg", 16, 16));
        ...
        servicesPanel.add(new ServiceCard("Wash and Fold", "washandFold.svg"));
        servicesPanel.add(new ServiceCard("Dry Clean", "dryClean.svg"));
        servicesPanel.add(new ServiceCard("Iron", "iron.svg"));
